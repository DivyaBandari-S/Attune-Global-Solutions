<div style="padding:20px">
    ...
    .col-md-6 {
       ...
       <div style="text-align: start; margin-bottom:16px;">
          <button class="btn btn-primary" style="background-color: #02114f; text-align:center; font-size:0.795rem;"><a href="{{route('emp-register')}}" style="outline:none;text-decoration:none;color:#fff;">ADD Employees</a></button>
          <button class="btn btn-primary" style="background-color: #02114f; text-align:center; font-size:0.795rem;"><a href="{{route('contractor-page')}}" style="outline:none;text-decoration:none;color:#fff;">Contractor List</a></button>
       </div>
     <div>
    ...
    <div class="col-md-3 mt-2" style=" background-color: #f2f2f2;; border-radius: 5px; color:rgb(2, 17, 79);  text-align:center; margin-right: 10px; padding: 15px;"><h6>Our Employees</h6>
       </div>
       <div class="col-md-8 mt-2 info" style=" background-color: #f2f2f2; border-radius: 5px; padding: 15px 20px; display: flex; flex-direction: column;">
       <div >
                 @if ($selectedCustomer)
    ...
    <div class="row" style=" width: 100%; padding:0;">
        <div class="col-md-3 mt-2" style=" background-color: #f2f2f2;; border-radius: 5px; margin-right: 10px; ">
            ...
            @foreach($allCustomers as $customer)
                    <div wire:click="selectCustomer('{{ $customer->customer_id }}', '{{ $customer->emp_id }}')" class="container mb-3" style="width:95%; background-color: {{ optional($selectedCustomer)->customer_id == $customer->customer_id && optional($selectedCustomer)->emp_id == $customer->emp_id ? '#ccc' : 'white' }}; border-radius: 5px; padding:10px auto; cursor: pointer;">
        ...
        <!-- Details of the selected person -->
            ...
            <div class="col-md-8 mt-2" style=" background-color: #f2f2f2; border-radius: 5px; padding: 10px 15px;">
            <div style="text-align: start; diplay:flex;">
            @php
            $selectCustomer = $this->selectedCustomer ??  $this->customers->first();
            @endphp
               <button class="button-btn btn btn-primary mb-2" wire:click="updateAndShowSoList('{{ optional ($selectCustomer)->emp_id }}')" style="{{ $activeButton === 'SO' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }} margin-right: 5px; border-radius: 5px; border: none;">
                    Working With
                </button>
                    <button class="button-btn btn btn-primary mb-2" style="background-color:grey ;" >Email Activities</button>
                    <button class="button-btn btn btn-primary mb-2"  style="background-color:  grey;" >Notes</button>
                    <button class="button-btn btn btn-primary mb-2" style="background-color: grey;" >Time Sheets</button>
            </div>
