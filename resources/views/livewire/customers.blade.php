<div style="padding:20px">
    ...
    <div style="text-align: start; margin-bottom:16px;">
        <button style="margin-right: 5px;" wire:click="open" class="button p-1 ">ADD Customers</button>
        <button style="margin-right: 5px;" wire:click="addSO" class="button p-1 ">ADD SO</button>
    </div>
    ...
    <div class="row" style="height:150px">
        ...
        @endphp
        <div class="col-md-3 p-0" style="background-color: #f2f2f2;margin-right:5px;">
        ...
        <div class="col-md-8 rounded" style="background-color: #f2f2f2; padding: 8px">
    ...
    <div class="row" style="margin-top: 15px;height:300px">
        <div class="col-md-3 rounded" style="background-color:#f2f2f2; height: auto; padding: 5px;margin-right:5px;max-height:300px;overflow-y:auto">
            ...
            <div class="row p-2" style="font-size: 13px">
                ...
                <div wire:click="selectCustomer('{{ $customer->customer_id }}')" class="container-11" style="margin-bottom:8px;height:25px;cursor: pointer; background-color: {{ $selectedCustomer && $selectedCustomer->customer_id == $customer->customer_id ? '#ccc' : 'white' }}; width: 500px; border-radius: 5px;padding:5px;">
        ...
        <div class="col-md-8 rounded" style="background-color: #f2f2f2; padding: 5px;max-height:300px;overflow-y:auto">
            @php
            $selectedPerson = $selectedCustomer ?? $customers->first();
            $isActive = $selectedPerson->status == 'active';
            @endphp
            <div style="text-align: start;" class="p-2">
                <button class="p-2" wire:click="showInvoices('{{$selectedPerson->customer_id}}')" style="{{ $activeButton === 'Invoices' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }} margin-right: 5px; border-radius: 5px; border: none;">
                    Invoices & Payments
                </button>

                <button class="p-2"  wire:click="updateAndShowSoList('{{$selectedPerson->customer_id}}')" style="{{ $activeButton === 'SO' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }} margin-right: 5px; border-radius: 5px; border: none;">
                    SO
                </button>

                <button class="p-2" wire:click="$set('activeButton', 'EmailActivities')" style="{{ $activeButton === 'EmailActivities' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }}margin-right: 5px; border-radius: 5px; border: none;">
                    Email Activities
                </button>
                <button class="p-2"  wire:click="$set('activeButton', 'Notes')" style="{{ $activeButton === 'Notes' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }}margin-right: 5px; border-radius: 5px; border: none;">
                    Notes
                </button>
                <button class="p-2" wire:click="$set('activeButton', 'Contacts')" style="{{ $activeButton === 'Contacts' ? 'background-color: rgb(2, 17, 79); color: white;' : 'background-color: grey; color: white;' }}margin-right: 5px; border-radius: 5px; border: none;">
                    Contacts
                </button>
