                    ...
                    <div class="card-body">
                        ...
                        <div class="emp" >
                            ...
                            <div class="form-group" >
                                ...
                                <button type="submit" wire:loading.attr="disabled" class="btn" style="background:green;">Save</button>
                               <a href="/emp-account-details"> <button type="button" wire:loading.attr="disabled" class="btn btn-primary">Next</button></a>
                            </div>
                            <div wire:debug></div>
